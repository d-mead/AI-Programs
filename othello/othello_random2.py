...
def main():
    ...
    d = 1
    while True:
        print(maxmin_ab_2(board, tok, d, -999999999999, 999999999999)[0])
        d += 1

# Q1
# This method implements alpha beta pruning by passing a and b variables
# through each recursion and refusing to go any further into a branch when
# the a is greater than or equal to b. a or b are updated each time a new
# board is scored if the new board score is greater than a or less than b.
...
def board_score(board):
    ...
    # Q2
    # the moves_left variable is how many open spots (essentially moves) are left.
    # When the number of moves remaining is less than 10, the weightings applied to
    # each heuristic changes to optimize play for late in the game.
